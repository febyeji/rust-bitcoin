...
mod tests {
    ...
    fn encode_to_unsized_writer() {
        ...
        assert_eq!(re_encoded.len(), SOME_TX.len() / 2);
        assert_eq!(raw_tx, *re_encoded);
    }
    ...
    fn consensus_serde() {
        ...
        let expected: Transaction = encoding::decode_from_slice(&tx_bytes).unwrap();
    ...
    fn transaction_verify() {
        ...
        let mut spending: Transaction = encoding::decode_from_slice(&hex!("")).unwrap();
        let spent1: Transaction = encoding::decode_from_slice(&hex!("")).unwrap();
        let spent2: Transaction = encoding::decode_from_slice(&hex!("")).unwrap();
        let spent3: Transaction = encoding::decode_from_slice(&hex!("")).unwrap();
    ...
    fn txin_txout_weight() {
        ...
        for (is_segwit, tx, expected_weight) in &txs {
            ...
            let tx: Transaction = encoding::decode_from_slice(&Vec::from_hex(tx).unwrap()).unwrap();
    ...
    fn tx_sigop_count() {
        ...
        fn return_p2sh(_outpoint: &OutPoint) -> Option<TxOut> {
            Some(
                encoding::decode_from_slice(&hex!(
